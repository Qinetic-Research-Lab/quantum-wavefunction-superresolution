...
Outputs:
    outputs/analysis/figure1_compact.png  (300 dpi)
    outputs/analysis/figure1_compact.pdf  (vector)
"""
...
def main() -> None:
    ...
    plt.rcParams.update({"font.size": 7.0, "axes.linewidth": 0.8,
                         "font.family": "DejaVu Sans"})
    fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(4.2, 1.55),
    ...
    ax2.set_ylabel(r"spline / CNN infidelity")
    ...
    fig.savefig(OUT / "figure1_compact.png", dpi=300)
    fig.savefig(OUT / "figure1_compact.pdf")
    print("wrote", OUT / "figure1_compact.png", "and", OUT / "figure1_compact.pdf")
